...
$user_name = 'Ramil'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
                ...
                <?php foreach ($goods as $key => $good): ?>
                    <li class="lots__item lot">
                        <div class="lot__image">
                            <img src="<?= $good["image"] ?>" width="350" height="260" alt="<?= $good["title"]; ?>">
                        </div>
                        <div class="lot__info">
                            <span class="lot__category"><?= $good["category"]; ?></span>
                            <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= $good["title"]; ?></a>
                            </h3>
